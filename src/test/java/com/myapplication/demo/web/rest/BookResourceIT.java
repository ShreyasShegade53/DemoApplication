...
import static com.myapplication.demo.web.rest.TestUtil.sameNumber;
...
import com.myapplication.demo.repository.BookRepository;
...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).price(DEFAULT_PRICE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
        return book;
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
